@echo off
REM Monster Killer Build Script for MSYS2 + raylib
...
set "CC=gcc"
set "CFLAGS=-std=c99 -Wall -Wextra -O2 -I. -Isrc -I%RAYLIB_SRC%"
set "LDFLAGS=-L%RAYLIB_LIB% -lraylib -lopengl32 -lgdi32 -lwinmm"

set "EXE=MonsterKiller.exe"
set "BUILD_DIR=build_msys"
...
echo.
echo BUILD SUCCESSFUL: %BUILD_DIR%\%EXE%
echo.
